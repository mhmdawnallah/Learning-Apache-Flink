...
public class InnerJoinExample
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataSet<Tuple2<Integer, String>> personSet = env.readTextFile(params.get("input1"))
                .map(new TextFilter());                           //presonSet = tuple of (1  John)
    ...
    public static final class InnerJoin implements JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>> {
