...
public class LeftOuterJoinExample
{
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.leftOuterJoin(locationSet, JoinOperatorBase.JoinHint.OPTIMIZER_CHOOSES).where(0) .equalTo(0)
    ...
    public static final class LeftOuterJoin implements JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>{
