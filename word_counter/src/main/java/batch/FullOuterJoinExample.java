...
public class FullOuterJoinExample
{
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.fullOuterJoin(locationSet, JoinOperatorBase.JoinHint.OPTIMIZER_CHOOSES).where(0) .equalTo(0)
                .with(new FullOuterJoin());
    ...
    public static final class FullOuterJoin implements JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>> {
